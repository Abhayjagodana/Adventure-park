...
export default function Sidebar({ currentPage }) {
    ...
    const links = [
        ...
        { href: "/course", name: "Rides", page: "Rides" },
        { href: "/About", name: "Resort", page: "Resort" },
        { href: "/blogger/b_login", name: "Package", page: "package" },
        { href: "/developer", name: "Booking", page: "Booking" },
    ...
    return (
        <div className="fixed w-64 h-full bg-gray-200 overflow-auto p-4">
